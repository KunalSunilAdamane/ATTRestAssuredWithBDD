...
public class CreatePlaylist {
	...
	public void createplaylist()
	{
		...
		requestbody.setName("Bhajan Geet");
		requestbody.setDescription("Collection of Bhajan's");
		requestbody.setPublic(false);
	
		Playlist responsebody = given(request)
		...
		String expectedName = requestbody.getName();
		String actualName = responsebody.getName();
